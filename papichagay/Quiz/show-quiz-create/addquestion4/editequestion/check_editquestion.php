...
if(isset($_POST['submit'])){
    ...
    if($_FILES["filUpload"]["name"] != ''){
      ...
      $sql = "UPDATE question SET questionname = '$questionname', choice1 = '$choice1', choice2 = '$choice2', choice3 = '$choice3', choice4 = '$choice4', answer = '$answer' ,question_img = '$url1' WHERE  id = '$id' ";
    ...
    if($_FILES["filUpload1"]["name"] != ''){
      ...
      $sql = "UPDATE question SET questionname = '$questionname', choice1 = '$choice1', choice2 = '$choice2', choice3 = '$choice3', choice4 = '$choice4', answer = '$answer' , choice1_img = '$url2' WHERE  id = '$id' ";
    ...
    if($_FILES["filUpload2"]["name"] != ''){
      ...
      $sql = "UPDATE question SET questionname = '$questionname', choice1 = '$choice1', choice2 = '$choice2', choice3 = '$choice3', choice4 = '$choice4', answer = '$answer' , choice2_img = '$url3' WHERE  id = '$id' ";
    ...
    if($_FILES["filUpload3"]["name"] != ''){
      ...
      $sql = "UPDATE question SET questionname = '$questionname', choice1 = '$choice1', choice2 = '$choice2', choice3 = '$choice3', choice4 = '$choice4', answer = '$answer', choice3_img = '$url4' WHERE  id = '$id' ";
    ...
    if($_FILES["filUpload4"]["name"] != ''){
      ...
      $sql = "UPDATE question SET questionname = '$questionname', choice1 = '$choice1', choice2 = '$choice2', choice3 = '$choice3', choice4 = '$choice4', answer = '$answer' , choice4_img = '$url5' WHERE  id = '$id' ";
