...
<nav class="sidebar close">
    ...
    <div class="dashboard">
        <table style="margin-top: -15px; margin-left: 10px;">
            ...
            <form action="delete.php?id=<?php echo $id ?>&q_id=<?php echo $q_id ?>" method="post"></form>
                <tr>
                    <td>โจทย์</td>
                    <td>
                ...
                <tr>
                    ...
                    <?php } ?>
                    <?php if ($row['choice5_img'] != '') { ?>
                            <p> <img class='image' src="<?php echo 'uploads/' . $row['choice5_img']; ?>" width='300px' height='180px'></p>
                    <?php }?>
                    </td>
