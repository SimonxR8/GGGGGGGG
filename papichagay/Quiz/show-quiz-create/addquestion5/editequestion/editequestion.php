...
session_start();
$sql = "SELECT * FROM tb_member INNER JOIN question5 where questionid = $page_id and id = $back_id and tb_member.member_code='" . $_SESSION['username'] . "'";
                ...
                <div>
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; margin: 10px;">
                        ...
                        <?php if ($row['answer'] == $f) { ?>
                            ...
                            <option value="ค">ค</option>
                            <option value="ง">ง</option>
                            <option value="จ" selected>จ</option>
                        <?php } ?>
                        </select>
                    </div>
